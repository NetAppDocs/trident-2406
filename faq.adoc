...
Yes, Astra Trident can be installed offline. Refer to link:./trident-install/kubernetes-deploy.html[Learn about Astra Trident installation^].
...
You can locally generate and modify the exact manifest files Astra Trident uses for installation, if needed. Refer to link:trident-install/kubernetes-customize-deploy-tridentctl.html[Customize tridentctl installation^].
