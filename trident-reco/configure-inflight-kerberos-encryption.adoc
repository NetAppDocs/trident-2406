...
* Ensure that you have enabled Astra Control Provisioner on the managed Red Hat OpenShift cluster. Refer to link:../trident-use/enable-acp.html[Enable Astra Control Provisioner^] for instructions.
* Ensure that you have access to the `tridentctl` utility.
